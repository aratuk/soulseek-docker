...
RUN apt-get update && \
    ...
    apt-get install -y binutils ca-certificates curl dbus fonts-noto-cjk iproute2 locales openbox patch supervisor tigervnc-standalone-server tigervnc-tools tzdata --no-install-recommends && \
